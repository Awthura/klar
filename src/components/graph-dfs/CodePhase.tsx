...
import { graphDfsCode, graphDfsBridge } from "@/lib/traces/graphDfs";

export default function GraphDfsCodePhase() {
  ...
  const highlightLines = highlightedLine
    ...
    ? [graphDfsBridge[highlightedMathIdx].codeLine]
    : [];
  ...
  return (
    <section className="mb-16">
      <PhaseHeader
        phase={3}
        title="The Code"
        subtitle="Mapping recursive DFS to Python with a nested explore function"
      />
          ...
          <div>
            ...
            <CodeBlock
              ...
              onLineHover={(line) => {
                ...
                if (line) {
                  const idx = graphDfsBridge.findIndex((b) => b.codeLine === line);
