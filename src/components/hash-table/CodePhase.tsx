...
import { hashTableCode, hashTableBridge } from "@/lib/traces/hashTable";

export default function HashTableCodePhase() {
  ...
  const highlightLines = highlightedLine
    ...
    ? [hashTableBridge[highlightedMathIdx].codeLine]
    : [];
  ...
  return (
    <section className="mb-16">
      <PhaseHeader
        phase={3}
        title="The Code"
        subtitle="Mapping hash table operations to a Python class with chaining"
      />
          ...
          <div>
            ...
            <CodeBlock
              ...
              onLineHover={(line) => {
                ...
                if (line) {
                  const idx = hashTableBridge.findIndex((b) => b.codeLine === line);
