...
import { svmCode, svmBridge } from "@/lib/traces/svm";

export default function SVMCodePhase() {
  ...
  const highlightLines = highlightedLine
    ...
    ? [svmBridge[highlightedMathIdx].codeLine]
    : [];
          ...
          <div>
            ...
            <CodeBlock
              ...
              onLineHover={(line) => {
                ...
                if (line) {
                  const idx = svmBridge.findIndex((b) => b.codeLine === line);
