...
import { linearRegressionCode, linearRegressionBridge } from "@/lib/traces/linearRegression";

export default function LinearRegressionCodePhase() {
  ...
  const highlightLines = highlightedLine
    ...
    ? [linearRegressionBridge[highlightedMathIdx].codeLine]
    : [];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div>
            ...
            <div className="space-y-2">
              {linearRegressionBridge.map((item, idx) => (
                <div
                  key={idx}
          ...
          <div>
            ...
            <CodeBlock
              ...
              onLineHover={(line) => {
                ...
                if (line) {
                  const idx = linearRegressionBridge.findIndex((b) => b.codeLine === line);
