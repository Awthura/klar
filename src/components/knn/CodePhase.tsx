...
import { knnCode, knnBridge } from "@/lib/traces/knn";

export default function KnnCodePhase() {
  ...
  const highlightLines = highlightedLine
    ...
    ? [knnBridge[highlightedMathIdx].codeLine]
    : [];
          ...
          <div>
            ...
            <CodeBlock
              ...
              onLineHover={(line) => {
                ...
                if (line) {
                  const idx = knnBridge.findIndex((b) => b.codeLine === line);
