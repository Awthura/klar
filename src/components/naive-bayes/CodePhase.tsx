...
import { naiveBayesCode, naiveBayesBridge } from "@/lib/traces/naiveBayes";

export default function NaiveBayesCodePhase() {
  ...
  const highlightLines = highlightedLine
    ...
    ? [naiveBayesBridge[highlightedMathIdx].codeLine]
    : [];
          ...
          <div>
            ...
            <CodeBlock
              ...
              onLineHover={(line) => {
                ...
                if (line) {
                  const idx = naiveBayesBridge.findIndex((b) => b.codeLine === line);
