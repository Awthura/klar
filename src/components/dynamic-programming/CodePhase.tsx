...
import { dpCode, dpBridge } from "@/lib/traces/dp";

export default function DpCodePhase() {
  ...
  const highlightLines = highlightedLine
    ...
    ? [dpBridge[highlightedMathIdx].codeLine]
    : [];
  ...
  return (
    <section className="mb-16">
      <PhaseHeader
        phase={3}
        title="The Code"
        subtitle="Mapping the Fibonacci recurrence to bottom-up Python"
      />
          ...
          <div>
            ...
            <CodeBlock
              ...
              onLineHover={(line) => {
                ...
                if (line) {
                  const idx = dpBridge.findIndex((b) => b.codeLine === line);
