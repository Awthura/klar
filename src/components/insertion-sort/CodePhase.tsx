...
import { insertionSortCode, insertionSortBridge } from "@/lib/traces/insertionSort";

export default function InsertionSortCodePhase() {
  ...
  const highlightLines = highlightedLine
    ...
    ? [insertionSortBridge[highlightedMathIdx].codeLine]
    : [];
  ...
  return (
    <section className="mb-16">
      <PhaseHeader
        phase={3}
        title="The Code"
        subtitle="Bridge from loop invariant to Python implementation"
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div>
            ...
            <div className="space-y-2">
              {insertionSortBridge.map((item, idx) => (
                <div
                  key={idx}
          ...
          <div>
            ...
            <CodeBlock
              ...
              onLineHover={(line) => {
                ...
                if (line) {
                  const idx = insertionSortBridge.findIndex((b) => b.codeLine === line);
