...
import { heapCode, heapBridge } from "@/lib/traces/heap";

export default function HeapCodePhase() {
  ...
  const highlightLines = highlightedLine
    ...
    ? [heapBridge[highlightedMathIdx].codeLine]
    : [];
  ...
  return (
    <section className="mb-16">
      <PhaseHeader
        phase={3}
        title="The Code"
        subtitle="Mapping heap operations to Python with sift-down"
      />
          ...
          <div>
            ...
            <CodeBlock
              ...
              onLineHover={(line) => {
                ...
                if (line) {
                  const idx = heapBridge.findIndex((b) => b.codeLine === line);
