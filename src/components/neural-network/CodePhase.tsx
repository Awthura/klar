...
import { neuralNetworkCode, neuralNetworkBridge } from "@/lib/traces/neuralNetwork";

export default function NeuralNetworkCodePhase() {
  ...
  const highlightLines = highlightedLine
    ...
    ? [neuralNetworkBridge[highlightedMathIdx].codeLine]
    : [];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div>
            ...
            <div className="space-y-2">
              {neuralNetworkBridge.map((item, idx) => (
                <div
                  key={idx}
          ...
          <div>
            ...
            <CodeBlock
              code={neuralNetworkCode}
              highlightLines={highlightLines}
              onLineHover={(line) => {
                setHighlightedLine(line);
                if (line) {
                  const idx = neuralNetworkBridge.findIndex((b) => b.codeLine === line);
