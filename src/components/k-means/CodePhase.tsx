...
import { kMeansCode, kMeansBridge } from "@/lib/traces/kMeans";

export default function KMeansCodePhase() {
  ...
  const highlightLines = highlightedLine
    ...
    ? [kMeansBridge[highlightedMathIdx].codeLine]
    : [];
          ...
          <div>
            ...
            <CodeBlock
              ...
              onLineHover={(line) => {
                ...
                if (line) {
                  const idx = kMeansBridge.findIndex((b) => b.codeLine === line);
