...
import { trieCode, trieBridge } from "@/lib/traces/trie";

export default function TrieCodePhase() {
  ...
  const highlightLines = highlightedLine
    ...
    ? [trieBridge[highlightedMathIdx].codeLine]
    : [];
  ...
  return (
    <section className="mb-16">
      <PhaseHeader
        phase={3}
        title="The Code"
        subtitle="Bridge from prefix tree operations to Python implementation"
      />
          ...
          <div>
            ...
            <CodeBlock
              ...
              onLineHover={(line) => {
                ...
                if (line) {
                  const idx = trieBridge.findIndex((b) => b.codeLine === line);
