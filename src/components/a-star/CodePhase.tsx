...
import { aStarCode, aStarBridge } from "@/lib/traces/aStar";

export default function AStarCodePhase() {
  ...
  const highlightLines = highlightedLine
    ...
    ? [aStarBridge[highlightedMathIdx].codeLine]
    : [];
  ...
  return (
    <section className="mb-16">
      <PhaseHeader
        phase={3}
        title="The Code"
        subtitle="Bridge from heuristic search formulation to Python implementation"
      />
          ...
          <div>
            ...
            <CodeBlock
              ...
              onLineHover={(line) => {
                ...
                if (line) {
                  const idx = aStarBridge.findIndex((b) => b.codeLine === line);
