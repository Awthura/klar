...
import { graphBfsCode, graphBfsBridge } from "@/lib/traces/graphBfs";

export default function GraphBfsCodePhase() {
  ...
  const highlightLines = highlightedLine
    ...
    ? [graphBfsBridge[highlightedMathIdx].codeLine]
    : [];
  ...
  return (
    <section className="mb-16">
      <PhaseHeader
        phase={3}
        title="The Code"
        subtitle="Mapping graph theory to Python with collections.deque"
      />
          ...
          <div>
            ...
            <CodeBlock
              ...
              onLineHover={(line) => {
                ...
                if (line) {
                  const idx = graphBfsBridge.findIndex((b) => b.codeLine === line);
