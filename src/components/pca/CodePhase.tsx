...
import { pcaCode, pcaBridge } from "@/lib/traces/pca";

export default function PCACodePhase() {
  ...
  const highlightLines = highlightedLine
    ...
    ? [pcaBridge[highlightedMathIdx].codeLine]
    : [];
          ...
          <div>
            ...
            <CodeBlock
              ...
              onLineHover={(line) => {
                ...
                if (line) {
                  const idx = pcaBridge.findIndex((b) => b.codeLine === line);
