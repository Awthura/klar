...
import { randomForestCode, randomForestBridge } from "@/lib/traces/randomForest";

export default function RandomForestCodePhase() {
  ...
  const highlightLines = highlightedLine
    ...
    ? [randomForestBridge[highlightedMathIdx].codeLine]
    : [];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div>
            ...
            <div className="space-y-2">
              {randomForestBridge.map((item, idx) => (
                <div
                  key={idx}
          ...
          <div>
            ...
            <CodeBlock
              ...
              onLineHover={(line) => {
                ...
                if (line) {
                  const idx = randomForestBridge.findIndex((b) => b.codeLine === line);
