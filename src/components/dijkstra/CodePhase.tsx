...
import { dijkstraCode, dijkstraBridge } from "@/lib/traces/dijkstra";

export default function DijkstraCodePhase() {
  ...
  const highlightLines = highlightedLine
    ...
    ? [dijkstraBridge[highlightedMathIdx].codeLine]
    : [];
  ...
  return (
    <section className="mb-16">
      <PhaseHeader
        phase={3}
        title="The Code"
        subtitle="Mapping greedy relaxation to Python with heapq"
      />
          ...
          <div>
            ...
            <CodeBlock
              ...
              onLineHover={(line) => {
                ...
                if (line) {
                  const idx = dijkstraBridge.findIndex((b) => b.codeLine === line);
