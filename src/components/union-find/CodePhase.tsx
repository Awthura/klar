...
import { unionFindCode, unionFindBridge } from "@/lib/traces/unionFind";

export default function UnionFindCodePhase() {
  ...
  const highlightLines = highlightedLine
    ...
    ? [unionFindBridge[highlightedMathIdx].codeLine]
    : [];
  ...
  return (
    <section className="mb-16">
      <PhaseHeader
        phase={3}
        title="The Code"
        subtitle="Bridge from set operations to Python implementation"
      />
          ...
          <div>
            ...
            <CodeBlock
              ...
              onLineHover={(line) => {
                ...
                if (line) {
                  const idx = unionFindBridge.findIndex((b) => b.codeLine === line);
