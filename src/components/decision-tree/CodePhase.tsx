...
import { decisionTreeCode, decisionTreeBridge } from "@/lib/traces/decisionTree";

export default function DecisionTreeCodePhase() {
  ...
  const highlightLines = highlightedLine
    ...
    ? [decisionTreeBridge[highlightedMathIdx].codeLine]
    : [];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div>
            ...
            <div className="space-y-2">
              {decisionTreeBridge.map((item, idx) => (
                <div
                  key={idx}
          ...
          <div>
            ...
            <CodeBlock
              ...
              onLineHover={(line) => {
                ...
                if (line) {
                  const idx = decisionTreeBridge.findIndex((b) => b.codeLine === line);
