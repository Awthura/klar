...
import { logisticRegressionCode, logisticRegressionBridge } from "@/lib/traces/logisticRegression";

export default function LogisticRegressionCodePhase() {
  ...
  const highlightLines = highlightedLine
    ...
    ? [logisticRegressionBridge[highlightedMathIdx].codeLine]
    : [];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div>
            ...
            <div className="space-y-2">
              {logisticRegressionBridge.map((item, idx) => (
                <div
                  key={idx}
          ...
          <div>
            ...
            <CodeBlock
              ...
              onLineHover={(line) => {
                ...
                if (line) {
                  const idx = logisticRegressionBridge.findIndex((b) => b.codeLine === line);
